...
<div class="container d-flex justify-content-center mt-5">
    <form class="w-50" method="POST" action="controller.php?mode=newBook">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="bookTitle" name="bookTitle" placeholder="Storia sulla mia pelle" required>
        </div>
        <div class="mb-3">
            <label for="year" class="form-label">Year</label>
            <input type="number" class="form-control" id="year" name="year" placeholder="2005" required>
        </div>
        <div class="mb-3">
            <label for="authorName" class="form-label">Author Name</label>
            <input type="text" class="form-control" id="authorName" name="authorName" placeholder="NIcolai Lilin" required>
        </div>
        <div class="mb-3">
